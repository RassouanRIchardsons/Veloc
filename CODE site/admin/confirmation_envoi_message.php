...
<!-- HOME -->                    
                    ...
                    <div class="modal-content">
                                ...
                                <div class="card bg-light">
                                    <article class="card-body d-flex justify-content-center flex-column mx-auto" style="max-width: 500px;">                                      
                                        <!-- ADRESSE -->
                                        <h2 class="card-title mt-3 text-center righteous"><i class="fas fa-biking fa-2x mr-1" aria-hidden="true"></i>Votre message a bien été envoyé !</h2>
